...
public class VerseCursorAdapter extends SimpleCursorAdapter{
	...
	public VerseCursorAdapter(Context context, int layout, Cursor c,
	...
	public View getView(int pos, View inView, ViewGroup parent) {
		...
		TextView verseIDTextView = (TextView) v.findViewById(to[0]);
		...
		if(prefs.getBoolean("isTransVerses", true)){
			TextView verseTextView = (TextView) v.findViewById(to[1]);
